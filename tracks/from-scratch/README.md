...
| 5 | BPE tokenizer from scratch | | [minbpe — minimal byte-pair encoding implementation](https://github.com/karpathy/minbpe) |
| 6 | Train a GPT yourself | | [nanoGPT — the simplest repo for training a GPT](https://github.com/karpathy/nanoGPT) |
