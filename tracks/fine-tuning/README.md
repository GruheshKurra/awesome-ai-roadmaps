...
| 4 | Fine-tuning with LoRA in practice | | [Hugging Face PEFT — LoRA conceptual guide](https://huggingface.co/docs/peft/main/en/conceptual_guides/lora) |
...
| 6 | Direct Preference Optimization | **[Direct Preference Optimization (DPO) — How to fine-tune LLMs directly without reinforcement learning](https://www.youtube.com/watch?v=k2pD3k1485A)** | [Rafailov et al. 2023 — DPO: Your Language Model is Secretly a Reward Model](https://arxiv.org/abs/2305.18290) |
